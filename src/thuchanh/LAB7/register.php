...
if( ! empty( $_POST ) ) {
	...
	$uemail = ! empty( $_POST['txtemail'] ) ? $_POST['txtemail']: '';
...
?>
	...
	<form method="POST">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="email" name="txtemail" id="" class="form-control" placeholder="Email" required="">
			</div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
			<div class="col-sm-offset-2 col-sm-10"><button type="submit">Sign Up</button></div>
		</div>
	</form>
